...
class BERTClassifier:
    ...
    def load_model(self) -> bool:
        ...
        try:
            ...
            if label_encoder_path.exists():
                ...
                logger.info(
                    f"Label encoder loaded with classes: {self.label_encoder.classes_}"
                )
            else:
                ...
                logger.info(
                    f"Created and saved label encoder with classes: {self.label_encoder.classes_}"
                )
    ...
    def predict(self, text: str) -> Tuple[str, float]:
        ...
        try:
            ...
            logger.info(
                f"Predicted intent: {predicted_intent} (confidence: {confidence:.3f})"
            )
    ...
    def predict_batch(self, texts: List[str]) -> List[Tuple[str, float]]:
        ...
        try:
            ...
            return [("NO DETECTED", 0.0)] * len(
                texts
            )  # Return special category for errors
