...
def train_model(model, train_loader, test_loader, criterion, optimizer, epochs, device):
    ...
    for epoch in range(epochs):
        ...
        if accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), os.path.join(os.path.dirname(__file__), 'lstm_model.pt'))
...
def main():
    ...
    try:
        ...
        data_path = os.path.join(os.path.dirname(__file__), "training_data/intent_data.csv")
