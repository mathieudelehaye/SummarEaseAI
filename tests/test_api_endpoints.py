...
class TestAPIEndpoints:
    ...
    def test_intent_bert_endpoint_success(self, mock_classifier, client):
        ...
        response = client.post('/intent_bert', 
    ...
    def test_summarize_endpoint_success(self, mock_openai_class, client):
        ...
        assert response.status_code in [200, 400, 500]  # Accept 400 for missing data too
    ...
    @patch('backend.summarizer.ChatOpenAI')
    def test_summarize_multi_source_success(self, mock_openai_class, mock_agent_class, client):
        ...
        agent_result = {
            ...
            'summaries': {
                'Test Article 1': 'Summary 1',
                'Test Article 2': 'Summary 2'
            },
            'agent_powered': True,
        ...
        response = client.post('/summarize_multi_source',
                               data=json.dumps(data),
                               content_type='application/json')
    ...
    def test_summarize_multi_source_error(self, mock_agent_class, client):
        ...
        mock_agent = Mock()
        mock_agent_class.return_value = mock_agent
        mock_agent.run_multi_source_search_with_agents.side_effect = Exception("Agent error")
...
class TestAPIResponseFormat:
    ...
    def test_intent_response_format(self, mock_classifier, client):
        ...
        response = client.post('/intent', 
                             json={'text': 'AI technology'},
                             content_type='application/json')
        
        data = json.loads(response.data)
        
        # Check required fields
        required_fields = ['text', 'intent', 'confidence', 'model_type', 'model_loaded', 'categories_available', 'timestamp']
    ...
    def test_intent_bert_response_format(self, mock_classifier, client):
        ...
        # Check required fields
        required_fields = ['text', 'intent', 'confidence', 'model_type', 'model_loaded', 'categories_available', 'gpu_accelerated', 'timestamp']
        for field in required_fields:
            assert field in data
